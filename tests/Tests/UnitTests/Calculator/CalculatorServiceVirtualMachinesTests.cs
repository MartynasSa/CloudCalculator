...
public class CalculatorServiceVirtualMachinesTests(WebApplicationFactory<Program> factory) : TestBase(factory)
{
    ...
    [Fact]
    public async Task CalculateCostComparisonsAsync_WithVirtualMachines_SmallUsage_ReturnsValidResult()
    {
        // Arrange
        ...
        {
            Assert.Contains(cloudCost.CostDetails, cd => cd.ResourceSubCategory == ResourceSubCategory.VirtualMachines);
        }
    ...
    [Fact]
    public async Task CalculateCostComparisonsAsync_WithVirtualMachines_MediumUsage_ReturnsValidResult()
    {
        // Arrange
        var service = GetService();
        var calculationRequest = new CalculationRequest
    ...
    [Fact]
    public async Task CalculateCostComparisonsAsync_WithVirtualMachines_LargeUsage_ReturnsValidResult()
    {
        // Arrange
        var service = GetService();
        var calculationRequest = new CalculationRequest
    ...
    [Fact]
    public async Task CalculateCostComparisonsAsync_WithVirtualMachines_ExtraLargeUsage_ReturnsValidResult()
    {
        // Arrange
        var service = GetService();
        var calculationRequest = new CalculationRequest
    ...
    [Fact]
    public async Task CalculateCostComparisonsAsync_WithVirtualMachines_CostsIncreaseWithUsageSize()
    {
        // Arrange
        var service = GetService();
        ...
        Assert.True(largeAwsCost.TotalMonthlyPrice >= smallAwsCost.TotalMonthlyPrice,
            "Larger usage size should have equal or higher costs for VirtualMachines");
